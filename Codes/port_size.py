...
def organize_s2compare():
    ...
    df = pd.read_csv('~/Desktop/WBCA-master/DataAnalysis/s2_compare.csv', index_col=0, header=0)
    ...
    df.to_csv('~/Desktop/WBCA-master/Release/voxel_region.csv', header=True, index=True)
...
def reglist_unique():
    ...
    conn_matrix = pd.read_csv('~/Desktop/WBCA-master/Release/conn_matrix.csv', index_col=0, header=0)
    ...
    df1.to_csv('~/Desktop/WBCA-master/Release/finale.csv')
...
def voxel_vs_connstr():
    ...
    df1 = pd.read_csv('~/Desktop/WBCA-master/Release/voxel_region.csv', index_col=0, header=0)
    df2 = pd.read_csv('~/Desktop/WBCA-master/Release/finale.csv', index_col=0, header=0)
    ...
    df2.to_csv('~/Desktop/WBCA-master/Release/finale.csv', header=True, index=True)
...
def num_cell_method2():
    ...
    df2.to_csv('~/Desktop/WBCA-master/Release/finale.csv')

def connectivitystr():
    # fill in connectivity_strength_row with the matching (From)->(To) pair

    df = pd.read_csv('~/Desktop/WBCA-master/Release/finale.csv', index_col=0, header=0)
    df2 = pd.read_csv('~/Desktop/WBCA-master/Release/conn_matrix.csv', index_col=0, header=0)
    temp = []
    ...
    df.to_csv('~/Desktop/WBCA-master/Release/finale.csv')
...
def totalcs():
    ...
    df.to_csv('~/Desktop/WBCA-master/Release/finale.csv', index=True)
...
def matrix():
    ...
    for x, y, z in zip(df['From'], df['To'], df['n_out']):
       # print(x, y , z)
        df2.at[x,y] = z
    df2.to_csv('~/Desktop/WBCA-master/Release/finale_matrix.csv', index=True)
